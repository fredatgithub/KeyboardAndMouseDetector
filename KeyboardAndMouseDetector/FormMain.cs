#define DEBUG
using KeyboardAndMouseDetector.Properties;
using System;
...
namespace KeyboardAndMouseDetector
{
  public partial class FormMain : Form
  {
    ...
    private DateTime _startTimeKeyboard = DateTime.Now;
    private DateTime _endTimeKeyboard = DateTime.Now;
    private DateTime _startTimeMouse = DateTime.Now;
    private DateTime _endTimeMouse = DateTime.Now;
    ...
    {
      labelKeyboard.Text = "Keyboard not used since: 00:00:00:0000000";
      labelMouse.Text = "Mouse not used since: 00:00:00:0000000";
      timerKeyboard.Enabled = true;
      timerMouse.Enabled = true;
      timerKeyboard.Interval = 1;
      timerMouse.Interval = 1;
      _startTimeMouse = DateTime.Now;
      _endTimeMouse = DateTime.Now;
      _startTimeKeyboard = DateTime.Now;
      _endTimeKeyboard = DateTime.Now;
    }
    ...
    {
      _endTimeMouse = DateTime.Now;
      labelMouse.Text = $"Mouse not used since: {_endTimeMouse - _startTimeMouse}";
      labelMouse.Refresh();
    }
    ...
    {
      _endTimeKeyboard = DateTime.Now;
      labelKeyboard.Text = $"Keyboard not used since: {_endTimeKeyboard - _startTimeKeyboard}";
      labelKeyboard.Refresh();
    }
